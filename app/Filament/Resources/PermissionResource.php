...
class PermissionResource extends Resource
{
    ...
    {
        return Auth::user()?->can('viewAny', Permission::class);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                SelectFilter::make('guard_name')->label(__('filament-spatie-roles-permissions::filament-spatie.field.guard_name'))->multiple()->options(config('filament-spatie-roles-permissions.guard_names')),
            ])
            ...
            ->emptyStateActions(config('filament-spatie-roles-permissions.should_remove_empty_state_actions.permissions') ? [] : [Tables\Actions\CreateAction::make()]);
    }
